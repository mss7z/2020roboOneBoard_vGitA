...
let socket=new WebSocket(`ws://${base.hostname}:81/`);
...
class crossBtn{
	addSingleBtnNoLong(sendVal,classVal,innerVal){
	...
	createMyDiv(){
		...
		this.kantoOnBtn=this.addSingleBtnNoLong("N","kantoBtn btn","kantoON");
		this.selfMother.appendChild(this.kantoOnBtn);
		
		this.kantoOffBtn=this.addSingleBtnNoLong("S","kantoBtn btn","kantoOFF");
		this.selfMother.appendChild(this.kantoOffBtn);
...
socket.onopen = function(e) {
	...
	statusElem.innerHTML=`Connected to ${base.myName}!`;
};
...
socket.onclose = function(event) {
	...
	statusElem.innerHTML=`Disconnected from ${base.myName}`;;
};

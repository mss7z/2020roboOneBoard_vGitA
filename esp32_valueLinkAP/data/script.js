...
if(myHostname==""){
	myHostname="10.114.51.51";
}

let socket=new WebSocket(`ws://${myHostname}:81/`);
...
socket.onopen = function(e) {
	...
	statusElem.innerHTML=`Connected to ${myHostname}!`;
};
...
socket.onclose = function(event) {
	...
	statusElem.innerHTML=`Disconnected to ${location.hostname}`;;
};
